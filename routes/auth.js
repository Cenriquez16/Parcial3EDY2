...
router.post(
    '/newCoordenada',
    [
        check('CX', 'El valor de X es obligatorio').not().isEmpty(),
        check('CX', 'El valor de X es numérico').isNumeric(),
        check('CY', 'El valor de Y es obligatorio').not().isEmpty(),
        check('CY', 'El valor de Y es numérico').isNumeric(),
